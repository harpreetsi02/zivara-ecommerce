        ...
        <div className="w-full max-w-2xl">
          ...
          >
            ...
            <p className="text-white/60 text-sm md:text-base leading-8 mt-6 max-w-xl mx-auto">
              Your order # <span className="text-white">ZV{orderId}</span>{" "} has been cancelled successfully. Refund will reflect within 5-7 business days.
            </p>
      ...
      <div className="text-center mb-12 px-4">
        <div className="flex items-center justify-center gap-4">
          ...
          >
            ...
            <span className="text-xl md:text-4xl">ancel Order</span>
          </h1>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {step === 2 && (
            <div>
              ...
              {/* Warning */}
              <div
                className="relative overflow-hidden rounded-4xl bg-red-50 border border-red-100 p-8 mb-8"
              >
                <div className="flex gap-5">
                  <div
                    className="w-14 h-14 rounded-full bg-white flex items-center justify-center shrink-0"
                  >
                  ...
                  <div>
                    ...
                    <p className="text-red-500 text-sm leading-7 mt-4">
                      Once cancelled, this action cannot be undone. Refunds are processed within 5-7 business days.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-4 mt-10">
                <button
                  onClick={() => setStep(1)}
                  className="flex-1 py-5 rounded-full border border-gray-200 text-black uppercase tracking-[0.2em] text-sm hover:bg-black hover:text-white transition-all duration-300"
                >
                  Go Back
                </button>
                ...
                <button
                  ...
                  disabled={loading}
                  className={`flex-1 py-5 rounded-full uppercase tracking-[0.2em] text-sm text-white transition-all duration-300
                    ${loading
                      ? "bg-gray-300"
