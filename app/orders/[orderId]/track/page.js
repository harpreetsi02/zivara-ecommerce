    ...
    <section className="min-h-screen relative z-20 pt-24 pb-20 overflow-hidden">
      ...
      <div className="text-center mb-12 px-4">
        <div className="flex items-center justify-center gap-4">
          ...
          >
            <span className="text-5xl md:text-7xl leading-none">T</span>
            <span className="text-xl md:text-4xl">rack Order</span>
          </h1>
        </div>
      ...
      <div className="px-4 md:px-6 mb-10">
        <div className="max-w-5xl mx-auto">
          <div
            className="relative overflow-hidden rounded-[2.5rem] bg-black text-white"
          >
            {/* Glow */}
            ...
            {/* CONTENT */}
            <div
              className="relative p-8 md:p-12 flex flex-col md:flex-row md:items-center md:justify-between gap-10"
            >
              {/* LEFT */}
              <div>
                ...
                <p className="text-white/60 text-sm md:text-base leading-8 mt-6 max-w-xl">
                  Your package is on the way and expected to arrive today before 8 PM.
                </p>
              </div>

              {/* RIGHT */}
              <div
                className="bg-white/10 border border-white/10 backdrop-blur-md rounded-4xl p-6 md:min-w-[320px]"
              >
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative">
            {steps.map((step, i) => (
              <div
                key={i}
                className="flex gap-5 md:gap-8 mb-8"
              >
                {/* LEFT */}
                <div className="flex flex-col items-center shrink-0">
                  ...
                  {i < steps.length - 1 && (
                    <div
                      className={`w-0.5 flex-1 min-h-20 mt-3
                        ${step.done
                          ? "bg-black"
                          : "bg-gray-100"
                        }
                ...
                {/* RIGHT */}
                <div
                  className={`flex-1 rounded-4xl p-6 md:p-8 transition-all duration-300
                    ${step.done
                      ? "bg-[#f8f8f8]"
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-5 flex-wrap">
                    ...
                    {/* STATUS */}
                    <div
                      className={`px-5 py-3 rounded-full text-xs uppercase tracking-[0.2em]
                        ${step.done
                          ? "bg-black text-white"
