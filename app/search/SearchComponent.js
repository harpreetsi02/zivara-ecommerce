    ...
    <section className="min-h-screen bg-white pt-24 pb-20 overflow-hidden">
      ...
      <div className="px-4 md:px-6 mb-10">
        ...
        >
          ...
          {/* Glow */}
          <div className="absolute inset-y-0 left-0 w-24 bg-gradient-to-r from-black/5 to-transparent pointer-events-none"></div>
      ...
      <div className="px-4 md:px-6 mb-8">
        ...
        >
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-light text-black mt-4 break-words">
              "{query}"
            </h2>
      ...
      {products.length === 0 ? (
        ...
        <div className="flex flex-col items-center justify-center text-center px-6 mt-20">
          ...
          <p className="text-gray-400 text-sm md:text-base mt-5 leading-7 max-w-md">
            ...
            search. Try using another keyword.
          </p>
